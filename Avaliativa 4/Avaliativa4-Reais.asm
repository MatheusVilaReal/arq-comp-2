...
main:
	...
	subi	$sp, $sp, 72		# Matriz 3x3 de double ocupa 72 bytes
...
indice:					# Calcula e retorna um ponteiro para o elemento da matriz de índice [t0][t1]
	...
	sll	$v0, $v0, 3			# vezes 8 bytes por elemento por ser uma matriz de words
...
e1:	jal	indice			# Encontra o ponteiro para o índice da matriz
	l.d	$f12, ($v0)			# Carrega elemento apontado pelo endereço calculado
	li	$v0, 3			#
...
# a0: matriz, a1: linhas, a2: colunas
soma_diag_sec:				# Retorna somatório em f0
	subi	$sp, $sp, 4			#
	sw	$ra, ($sp)			# Empilha endereço retorno
	move	$a3, $a0			# Salva ponteiro para matriz em a3
	li	$t0, 0			# Contador de linhas (i)
	li	$t1, 2			# Contador de colunas (j)
	mov.d	$f0, $f30			# Somatório da diagonal secundária
s1:	jal	indice			# Encontra o ponteiro para o índice da matriz
	l.d	$f4, ($v0)			# Carrega elemento apontado pelo endereço calculado em t2
	add.d	$f0, $f0, $f4		# Soma ao somatório da diag. secundária
